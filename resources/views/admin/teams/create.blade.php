...
<div class="max-w-lg">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl font-bold text-gray-800">Байгууллага нэмэх</h1>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-6">
        <form method="POST" action="{{ route('admin.teams.store') }}" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="short_name" value="{{ old('short_name') }}" maxlength="50"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Лого (зураг)</label>
                <input type="file" name="logo" accept="image/*"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                <p class="text-xs text-gray-400 mt-1">PNG, JPG · Дээд тал 2MB</p>
